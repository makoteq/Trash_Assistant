...
export const database: DatabaseRecord[] = [
    {
        AIname: ["paper", "paper towel", "crossword puzzle", "envelope", "toilet tissue", "file", "jigsaw puzzle"],
        type: "Papier",
        color: "#383087",
    ...
    {
        AIname: ["pop bottle", "beer bottle", "beer glass", "red wine", "wine bottle"],
        type: "Szkło",
        color: "#009746",
        colorName: "Kolor pojemnika: Zielony",
    },
    {
        AIname: ["pomegranate", "fig", "lemon", "strawberry", "banana", "honeycomb", "custard apple"],
        type: "Bio",
        color: "#8F7459",
